...
/* Proces macierzysty pobiera status zakończenie potomka child, nie zawieszając swojej pracy.
 * Proces spi tyle ile podane w argumencie
 * Jeśli proces się nie zakończył, wysyła do dziecka sygnał SIGKILL / SIGTERM - ktorys z tych mozna bylo
 ...
 * CZYLI jedyna zmiana byl sleep z argv[1]
 * */
